...
|-------|-------------|-----------|
| 👔 **ผู้จัดการ** | รหัสผ่านผู้จัดการ (เริ่มต้น **9999**) | บริหารทุกอย่าง: จัดการพนักงาน, ลงเวลาทุกคน, อนุมัติ/ปฏิเสธการลา, ดู OT ทุกคน, แดชบอร์ด |
| 👤 **พนักงาน** | เลือกชื่อ + รหัส PIN ส่วนตัว | จัดการเฉพาะของตัวเอง: ดูข้อมูลตัวเอง, ลงเวลาเข้า-ออก, ยื่นลา + ดูสิทธิคงเหลือ, บันทึก OT |

- เปลี่ยนรหัสผู้จัดการได้ที่เมนู **พนักงาน → 🔑 รหัสผู้จัดการ**
- ตั้ง/แก้ PIN ของพนักงานแต่ละคนได้ในฟอร์มข้อมูลพนักงาน (ช่อง "รหัส PIN")
- ข้อมูลตัวอย่าง: PIN ของพนักงาน 3 คนคือ 1111 / 2222 / 3333
